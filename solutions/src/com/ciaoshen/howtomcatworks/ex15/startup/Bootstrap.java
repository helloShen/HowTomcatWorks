package com.ciaoshen.howtomcatworks.ex15.startup;
...
public final class Bootstrap {
  ...
  public static void main(String[] args) {
    System.setProperty("catalina.base", "/Users/Wei/github/HowTomcatWorks/");
    Connector connector = new HttpConnector();

    Context context = new StandardContext();
    // StandardContext's start method adds a default mapper
    context.setPath("/app15");
    context.setDocBase("app15");
    ...
    try {
      ...
      ((Lifecycle) host).start();   // Lifecycle Listener will execute the ContextConfig
