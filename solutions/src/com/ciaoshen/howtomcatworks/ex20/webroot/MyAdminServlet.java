package com.ciaoshen.howtomcatworks.ex20.webroot;
    ...
    private void listAllContexts(PrintWriter out) {
        try {
            ...
            while (it.hasNext()) {
                ...
                out.print(obj + " <a href=?action=removeContext&contextObjectName=" + URLEncoder.encode (obj.toString(), "UTF-8") + ">remove</a><br/>");
            }
        } catch (Exception e) {
